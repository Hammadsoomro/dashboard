          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-black/5 bg-white/70 px-3 py-1 text-xs font-medium shadow-sm">
                <Sparkles className="h-3.5 w-3.5 text-emerald-500" /> Web
                Preset: Soft Pop
              </div>
              ...
              <p className="mt-4 text-neutral-600 dark:text-neutral-300 max-w-prose">
                Track leads, proposals, revenue and more. Floating, collapsible
                sidebar. Sticky navbar. Light and Dark modes. Built with
              ...
              <div className="mt-8 flex items-center gap-6 text-sm text-neutral-600 dark:text-neutral-300">
                ...
                <div className="flex items-center gap-2">
                  <UsersRound className="h-4 w-4 text-sky-500" /> Team-first
                </div>
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-amber-500" /> Polished UI
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="rounded-3xl border border-black/5 bg-white shadow-xl p-4 md:p-6">
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="rounded-xl bg-emerald-50 text-emerald-700 px-3 py-2 text-sm font-semibold">
                    +54.6% Leads
                  </div>
                  <div className="rounded-xl bg-sky-50 text-sky-700 px-3 py-2 text-sm font-semibold">
                    +35% YTD
                  </div>
                  <div className="rounded-xl bg-amber-50 text-amber-700 px-3 py-2 text-sm font-semibold">
                    78% Target
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {["Hammad", "Ayesha", "Bilal", "Zain", "Noor"].map((n, i) => (
              <div
                key={i}
                className="rounded-2xl border border-black/5 bg-white/80 backdrop-blur p-4 shadow"
              >
