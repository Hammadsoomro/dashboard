    ...
    try {
      ...
      const res = await fetch("/api/team", {
        ...
        body: JSON.stringify({
          ...
          email,
          password,
          role: newMemberIsAdmin ? "admin" : "member",
        }),
      });
      if (!res.ok) {
        ...
        {isAdmin ? (
          ...
          >
            ...
            <div className="sm:col-span-2">
              <button
                disabled={busy}
                className="inline-flex items-center gap-2 rounded-md bg-amber-500 px-4 py-2 text-white"
              >
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            Only team admins can create new team members.
          </p>
        )}
